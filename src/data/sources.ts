...
export const sources: Source[] = [
  ...
  },
  {
    ...
    feedUrl: 'https://api.github.com/repos/langchain-ai/langchain/releases/latest',
    description: 'LangChain公式リポジトリの最新安定版リリース情報',
    enabled: true,
  ...
  },
  {
    ...
    feedUrl: 'https://api.github.com/repos/vllm-project/vllm/releases/latest',
    description: 'vLLM公式リポジトリの最新安定版リリース情報',
    enabled: true,
  ...
  },
  {
    ...
    feedUrl: 'https://api.github.com/repos/ollama/ollama/releases/latest',
    description: 'Ollama公式リポジトリの最新安定版リリース情報',
    enabled: true,
    categories: ['artificial-intelligence', 'developer-tools', 'open-source'],
    imagePolicy: 'rss_only',
    sourceType: 'github_releases',
  },
  {
    ...
    feedUrl: 'https://api.github.com/repos/ggml-org/llama.cpp/releases/latest',
    description: 'llama.cpp公式リポジトリの最新安定版リリース情報',
    enabled: true,
    categories: ['artificial-intelligence', 'inference', 'open-source'],
    imagePolicy: 'rss_only',
    sourceType: 'github_releases',
